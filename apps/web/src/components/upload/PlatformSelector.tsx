 ...
 *
 * Grid of platform cards for selection.
 * Each card shows the platform icon, name, and brief description.
 */
function PlatformSelector({ onSelect }: PlatformSelectorProps) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        return (
          ...
          >
            <CardContent className="p-0 flex flex-col items-center text-center">
              ...
              {/* Description */}
              <p className="text-body-sm text-vsg-gray-500 dark:text-vsg-gray-400">
                Analyze your {config.name} followers, following, and engagement patterns.
              </p>

              {/* CTA indicator */}
              <div className="mt-4 text-body-sm font-medium text-vsg-orange-500 opacity-0 group-hover:opacity-100 transition-opacity">
                Select &rarr;
              </div>
            </CardContent>
          </Card>
      ...
      <Card padding="lg" className="opacity-60 cursor-not-allowed">
        <CardContent className="p-0 flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-xl bg-vsg-gray-200 dark:bg-vsg-gray-800 flex items-center justify-center mb-4">
            <span className="text-h4 text-vsg-gray-400">+</span>
          </div>
          <h3 className="text-h4 font-semibold text-vsg-gray-500 dark:text-vsg-gray-400 mb-2">
            More Platforms
          </h3>
          <p className="text-body-sm text-vsg-gray-400">
            YouTube, Threads, and more coming soon.
          </p>
        </CardContent>
      </Card>
    </div>
